    ...
    <div class="demo-split">
      ...
      <div class="demo-video-col">
        ...
        <div class="demo-video-cta">
          ...
          <div class="demo-helper">Lovable Insights tour — Visitors · Page Views · Views Per Visit · Duration · Bounce Rate. Then every learner does the same on their own product in Lab 1.</div>
        </div>
      </div>
    </div>
    <div class="notes">
