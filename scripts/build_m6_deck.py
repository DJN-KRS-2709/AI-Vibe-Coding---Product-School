...
<!-- 4. TODAY'S AGENDA · LMS reminder lives on slide 23 (right before the showcase) -->
...
<!-- 6. INSTRUCTOR-LED DEMO — Making Data-Driven Decisions -->
...
<!-- 7. RAPID-FIRE FEEDBACK LOOP — individual exercise · 10 min -->
...
<!-- 8. THE ITERATION MINDSET — 3 levers · loop diagram -->
...
<!-- 10. THREE LAYERS OF ANALYTICS — Internal · External · Custom (matrix mirrors PPTX) -->
...
<!-- 12. LAB 1 — Read Lovable Insights (10 min instructor-led) -->
...
<!-- 14. AI-POWERED ANALYSIS — Old way vs New way + the strategic prompt -->
...
<!-- 15. FROM DATA SIGNAL TO TECHNICAL FIX — Persona · Branching · Guardrail -->
...
<!-- 17. LAB 2 — AI Iteration Sprint (15 min) -->
...
<!-- 18. FINALIZE PROJECT DELIVERABLES — 15 min individual exercise -->
...
<!-- 19. LEARNER JOURNEY · M1 → M6 RECAP -->
...
<!-- 20. BREAK · between Learner Journey and the Final Project Showcase -->
...
<!-- 21. CAMERAS ON · pre-showcase reminder -->
...
<!-- 23. IMPORTANT REMINDER · LMS submission to certify -->
<section class="centered" data-title="Important · LMS Submission">
  <div class="inner" style="max-width: 960px;">
    <div class="demo-tag tag-activity" style="background: rgba(248,113,113,0.15); color: #fca5a5;">Important · Required to Certify</div>
    <h2>Before the showcase begins &mdash; read this.</h2>
    <p class="subtitle">Today's live demo is the celebration. The LMS submission is what unlocks your certificate. Both matter &mdash; but only one is required.</p>

    <div style="background: linear-gradient(135deg, rgba(248,113,113,0.08), rgba(251,191,36,0.06)); border: 1.5px solid rgba(248,113,113,0.3); border-radius: 16px; padding: 26px 30px; max-width: 760px; margin: 26px auto 18px;">
      <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 14px;">
        <div style="font-size: 28px;">📍</div>
        <div style="font-family:'Poppins',sans-serif; font-size: 18px; font-weight: 800; color: #fff;">Upload your Final Project to Docebo</div>
      </div>
      <p style="font-size: 15px; color: #e0e0f0; line-height: 1.65; text-align: left;">Every learner &mdash; volunteer presenter or not &mdash; must submit a finalised copy of the <strong>Final Project Deliverables</strong> (the live URL of your GitHub Pages showcase) to <strong>Docebo</strong> within <strong>7 days</strong> of this class to qualify for certification.</p>
    </div>

    <div style="display: flex; gap: 12px; justify-content: center; flex-wrap: wrap; margin-top: 14px;">
      <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: 10px; padding: 14px 20px; min-width: 210px; text-align: left;">
        <div style="font-family:'Poppins',sans-serif; font-size: 10px; font-weight: 800; letter-spacing: 0.15em; text-transform: uppercase; color: #6ee7b7; margin-bottom: 4px;">Where</div>
        <div style="font-size: 14px; color: #fff; font-weight: 600;">Docebo &middot; link pinned in <code>#cohort-channel</code></div>
      </div>
      <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: 10px; padding: 14px 20px; min-width: 210px; text-align: left;">
        <div style="font-family:'Poppins',sans-serif; font-size: 10px; font-weight: 800; letter-spacing: 0.15em; text-transform: uppercase; color: #fbbf24; margin-bottom: 4px;">When</div>
        <div style="font-size: 14px; color: #fff; font-weight: 600;">Within <strong>7 days</strong> of class</div>
      </div>
      <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: 10px; padding: 14px 20px; min-width: 210px; text-align: left;">
        <div style="font-family:'Poppins',sans-serif; font-size: 10px; font-weight: 800; letter-spacing: 0.15em; text-transform: uppercase; color: #f9a8d4; margin-bottom: 4px;">Who</div>
        <div style="font-size: 14px; color: #fff; font-weight: 600;">Every learner &mdash; no exceptions</div>
      </div>
    </div>

    <div class="notes">
      <h4>Speaker Notes</h4>
      <p>This is the certification gate. Make it stick: <em>"the showcase is the celebration. Docebo is the certificate."</em> Drop the Docebo link in <code>#cohort-channel</code> right after this slide and pin the message. Mention the 7-day window explicitly. Then transition straight into the showcase: <em>"now &mdash; let's hear who's going first."</em></p>
    </div>
  </div>
</section>

<!-- 24. SHOWCASE KICKOFF — Your Time to Shine -->
<section data-title="Your Time to Shine">
  <div class="inner" style="max-width: 1180px;">
    ...
    <div class="notes">
      ...
      <p>Give a 6–7 minute warning per presenter. If a learner is going long, cut respectfully — protect the rest of the showcase. The LMS reminder is on the previous slide if anyone asks.</p>
    </div>
  </div>
</section>

<!-- 25. KEY TAKEAWAYS · after the showcase, before the survey -->
