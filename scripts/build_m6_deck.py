...
<!-- 11. THREE LAYERS OF ANALYTICS — Internal · External · Custom -->
...
<!-- 17. AI-POWERED ANALYSIS — Old way vs New way + the strategic prompt -->
...
<!-- 18. FROM DATA SIGNAL TO TECHNICAL FIX — Persona · Branching · Guardrail -->
...
<!-- 20. LAB 2 — AI Iteration Sprint (15 min) -->
...
<!-- 21. FINALIZE PROJECT DELIVERABLES — 15 min individual exercise -->
...
<!-- 22. LEARNER JOURNEY · M1 → M6 RECAP -->
